...
const importData = async () => {
    try {
        ...
        const generalInfo = new GeneralInfo({
            name: 'Omkar Mahesh',
            title: 'Aspiring DevOps Engineer | Full-Stack Developer',
            subtitle: 'Cloud & GenAI Enthusiast',
            description: 'Mastering the synergy between code, cloud, and automation. With a core of elite DSA expertise, I deliver end-to-end excellence in Full-Stack development (MERN & Next.js), implement resilient Cloud-native systems, and drive efficiency through advanced DevOps pipelines. My goal is to deliver not just features, but a competitive advantage.',
