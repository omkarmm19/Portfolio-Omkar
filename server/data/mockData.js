...
const certifications = [
    // AWS — Most Prestigious (order 1–2)
    { order: 1,  title: 'AWS Certified Solutions Architect — Associate', issuer: 'Amazon Web Services', icon: 'devicon-amazonwebservices-plain colored', link: 'https://www.credly.com/badges/e0541226-e871-4e0f-9fc8-609dfd24f873/public_url' },
    { order: 2,  title: 'AWS Certified Cloud Practitioner',              issuer: 'Amazon Web Services', icon: 'devicon-amazonwebservices-plain colored', link: 'https://www.credly.com/badges/bad01b94-b5f9-4260-a1fb-8cc68aea78d5/public_url' },
    // Microsoft (order 3)
    { order: 3,  title: 'Azure Data Fundamentals (DP-900)',               issuer: 'Microsoft',           icon: 'fa-brands fa-microsoft',                 link: 'https://www.credly.com/badges/68487755-3375-4887-a1b3-4268023b3ec7/public_url' },
    // IBM (order 4–5)
    { order: 4,  title: 'DevOps Fundamentals',                            issuer: 'IBM',                 icon: 'fa-solid fa-infinity',                   link: 'https://courses.vit.skillsnetwork.site/certificates/d0bde818921c4b5982b1e4e647a77f9b' },
    { order: 5,  title: 'DevOps, Agile & Design Thinking',                issuer: 'IBM',                 icon: 'fa-solid fa-infinity',                   link: 'https://courses.vit.skillsnetwork.site/certificates/9c348048d331464cbcedaabd3cd335ac' },
    // Google (order 6–8)
    { order: 6,  title: 'Google IT Support Professional Certificate',      issuer: 'Google',              icon: 'fa-brands fa-google',                    link: 'https://www.credly.com/badges/7d04edcd-5d4f-4e25-bed1-48138478c5d2/public_url' },
    { order: 7,  title: 'Gen AI Academy',                                  issuer: 'Google',              icon: 'fa-brands fa-google',                    link: 'https://certificate.hack2skill.com/user/genai2/2025H2S04GENAI-A100367' },
    { order: 8,  title: 'The Bits and Bytes of Computer Networking',       issuer: 'Google',              icon: 'fa-brands fa-google',                    link: 'https://drive.google.com/file/d/1RM_JEV2iZ6GgyrXia8L-ORVejFJR55cu/view?usp=sharing' },
    // Postman (order 9)
    { order: 9,  title: 'API Fundamentals Student Expert',                 issuer: 'Postman',             icon: 'devicon-postman-plain colored',           link: 'https://badgr.com/public/assertions/toYF93bjSFKvqWqrHA9i2w' },
    // Oracle (order 10–11)
    { order: 10, title: 'Oracle Certified AI Foundations Associate',       issuer: 'Oracle',              icon: 'devicon-oracle-original colored',         link: 'https://drive.google.com/file/d/1IB9YpfeEnJAj0C9cNYwCgPIjery1Jabq/view?usp=sharing' },
    { order: 11, title: 'Oracle Certified Cloud Foundations Associate',    issuer: 'Oracle',              icon: 'devicon-oracle-original colored',         link: 'https://drive.google.com/file/d/1gswUO7jELq-Jy9p1gCFHZcRo1ZSs1O80/view?usp=sharing' },
    // NPTEL (order 12–13)
    { order: 12, title: 'Cloud Computing and Distributed Systems',         issuer: 'NPTEL',               icon: 'fa-solid fa-microchip',                  link: 'https://drive.google.com/file/d/1Q8a-JriSJzNFOw8nunz4ft1NhKf7Tztt/view?usp=sharing' },
    { order: 13, title: 'Introduction to Internet of Things',              issuer: 'NPTEL',               icon: 'fa-solid fa-microchip',                  link: 'https://drive.google.com/file/d/1A4zlPeUzu9Ixi-6htih1p1EoWjxbAPXR/view?usp=sharing' },
    // Forage (order 14)
    { order: 14, title: 'Data Visualization',                              issuer: 'TATA Forage',         icon: 'fa-solid fa-chart-bar',                  link: 'https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/Tata/MyXvBcppsW2FkNYCX_Tata%20Group_nvcYESxQthhFMataX_1725794820145_completion_certificate.pdf' },
    // Vityarthi (order 15–16)
    { order: 15, title: 'Fundamentals Of AIML',                            issuer: 'Vityarthi',           icon: 'fa-solid fa-robot',                      link: 'https://drive.google.com/file/d/13zmb5ZCjhYvBzKLjhGo0pNvdt_EKLwFS/view?usp=sharing' },
    { order: 16, title: 'Python Essentials',                               issuer: 'Vityarthi',           icon: 'fa-brands fa-python',                    link: 'https://drive.google.com/file/d/17Pfv-ITW9n52Xms5405Yp0El2Pp7GKMD/view?usp=sharing' }
];

const achievements = [
    { order: 1, title: 'PR and Outreach Lead',             issuer: 'Health O Tech Club',   icon: 'fa-solid fa-users',       spotlight: true  },
    { order: 2, title: '1st Rank in Google Gen AI Exchange', issuer: 'Google Program 2025', icon: 'fa-solid fa-trophy',      spotlight: true  },
    { order: 3, title: 'Leetcode DSA 100 Days Challenge',  issuer: 'Completed in Java',    icon: 'fa-solid fa-laptop-code', spotlight: false },
    { order: 4, title: 'Event Management Lead',            issuer: 'Mozilla Firefox Club', icon: 'fa-solid fa-users',       spotlight: false }
];
