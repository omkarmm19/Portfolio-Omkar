...
const Certifications = () => {
    ...
    const cardClasses = "bg-[var(--card-bg)] rounded-2xl shadow-lg p-6 border border-[var(--border-color)] flex items-center gap-4 hover:-translate-y-2 hover:shadow-xl hover:border-[var(--accent-primary)] transition-all duration-300 group";
